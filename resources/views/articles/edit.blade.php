                ...
                <div class="p-6 text-gray-900">
                    <form action="{{ route('articles.update', $article->id) }}" method="POST">
                        ...
                        <div>
                            ...
                            <div class="my-3">
                                <input value="{{ old('title', $article->title) }}" name="title" id="title-article"
                            ...
                            <div class="my-3">
                                <input value="{{ old('author', $article->author) }}" name="author" id="author"
                            ...
                            <button class="bg-slate-700 text-sm rounded-md px-2 py-2 text-white">Update</button>
                        </div>
                    </form>
                </div>
            </div>
